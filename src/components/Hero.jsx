    ...
    <section id="home" className="relative min-h-[90vh] md:min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 py-32 md:py-0 w-full">
        <div className="max-w-3xl">
          <div
            className="animate-fade-in inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-5 py-2 mb-8"
          >
          ...
          <h1
            className="animate-slide-up text-4xl md:text-5xl lg:text-7xl font-heading font-bold text-white leading-[1.1] mb-6"
          ...
          <p
            className="animate-slide-up text-lg md:text-xl text-white/70 font-light leading-relaxed mb-10 max-w-xl"
